...
public class TTP {
	...
	private Calendrier Optimum; // Meilleur calendrier
	...
	public TTP(String s) {
		...
		setOptimum(new Calendrier(getNbVilles(), getNbJournees()));
		setValeurOptimum(Integer.MAX_VALUE);
	...
	public Calendrier getOptimum() {
		return Optimum;
	}

	public void setOptimum(Calendrier optimum) {
		Optimum = optimum;
	}
	...
	public int cout(Calendrier cal, int fin) {
		if(fin == 0){
			return 0;
		}
		else {
	...
	public int coutTotal(Calendrier cal) {
	...
	*/
	public void calendrierOptimal() {
		...
		Calendrier cal = new Calendrier(this.nbVilles, this.nbJournees);
	...
	public void genererCalendrier(ArrayList<Journee> totalJ, int pos, int[] planif, Calendrier cal)  {
	 ...
	 * @param cal
	 */
	public void genererCalendrierMieux(ArrayList<Journee> totalJ, int pos, Calendrier cal)  {
